...
(1, 1, 'Sydney', 'Torkornoo', '', '10 Brookland Terrace,', 'Sayer Street,', 'Huntingdon', 'pe293nd', 222, 3525, '\"\"', 1);
...
(1, 'Default', '', 1, '2024-10-23 12:07:54', '2024-10-23 12:07:54');
...
(1, 1, 0, 1, 'Sydney', 'Torkornoo', 'sydney.torkornoo@gmail.com', '', '$2y$10$QTpbQuUjjKqyT4yAT5lrreuDgI2xSZCIc5yCq8dSl/Bmeq9Roo/ku', '', 0, '::1', 1, 0, '', '', '2024-10-23 13:09:33');
...
(1, 0, 0, 'INV-2024-00', '', 0, 'Your Store', 'http://localhost/opencart/', 1, 1, 'Sydney', 'Torkornoo', 'sydney.torkornoo@gmail.com', '', '[]', 0, '', '', '', '', '', '', '', '', 0, '', 0, '', '[]', '{\"code\":\"cod.cod\",\"name\":\"Cash On Delivery\"}', 1, 'Sydney', 'Torkornoo', '', '10 Brookland Terrace,', 'Sayer Street,', 'Huntingdon', 'pe293nd', 'United Kingdom', 222, 'Cambridgeshire', 3525, '{firstname} {lastname}\r\n{company}\r\n{address_1}\r\n{address_2}\r\n{city}, {zone} {postcode}\r\n{country}', '\"\"', '{\"code\":\"flat.flat\",\"name\":\"Flat Shipping Rate\",\"cost\":\"5.00\",\"tax_class_id\":\"9\",\"text\":\"$8.00\"}', '', 130.0000, 1, 0, 0.0000, 0, '', 1, '', 2, 'USD', 1.00000000, '::1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/130.0.0.0 Safari/537.36', 'en-US,en;q=0.9,fr-DZ;q=0.8,fr;q=0.7', '2024-10-23 13:09:52', '2024-10-23 13:09:57');
...
(1, 1, 41, 0, 'iMac', 'Product 14', 1, 100.0000, 100.0000, 22.0000, 0);
...
(1, 1, 'opencart', 'sub_total', 'Sub-Total', 100.0000, 1),
(2, 1, 'opencart', 'shipping', 'Flat Shipping Rate', 5.0000, 3),
(3, 1, 'opencart', 'tax', 'Eco Tax (-2.00)', 4.0000, 5),
(4, 1, 'opencart', 'tax', 'VAT (20%)', 21.0000, 5),
(5, 1, 'opencart', 'total', 'Total', 130.0000, 9);
...
(41, 0, 'Product 14', '', '', '', '', '', '', '', '', '', 976, 5, 'catalog/demo/imac_1.jpg', 8, 1, 100.0000, 0, 9, '2009-02-03', 5.00000000, 1, 0.00000000, 0.00000000, 0.00000000, 1, 1, 1, 3, 0, 1, '2009-02-03 21:07:26', '2024-10-23 14:40:47'),
...
CREATE TABLE `oc_review` (
  ...
  `date_added` datetime NOT NULL,
  `date_modified` datetime NOT NULL,
  `value_for_money` int(1) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
...
INSERT INTO `oc_review` (`review_id`, `product_id`, `customer_id`, `author`, `text`, `rating`, `status`, `date_added`, `date_modified`, `value_for_money`) VALUES
(1, 41, 1, 'syd', 'lodsdf e efw f wfw fwek wf', 3, 1, '2024-10-23 15:12:22', '2024-10-23 13:17:25', 0),
(2, 41, 1, 'Sydney Torkornoo', 'try model_product_product model_product_product model_product_product', 4, 1, '2024-10-23 13:56:46', '2024-10-23 13:57:11', 0),
(3, 41, 1, 'Sydney Torkornoo', 'try 3vfdfgd sdfsds sdg dhkgh hzdf xd', 4, 1, '2024-10-23 13:58:30', '2024-10-23 14:40:47', 5),
(4, 41, 1, 'Sydney Torkornoo', 'ds df dcjjdt ds df dcjjdt ds df dcjjdt ds df dcjjdt ds df dcjjdt ds df dcjjdt ds df dcjjdt ds df dcjjdt', 4, 1, '2024-10-23 13:58:52', '2024-10-23 13:59:38', 3),
(5, 41, 1, 'Sydney Torkornoo', 'nother 1 sdfsdfs sdvsdvs nother 1 sdfsdfs sdvsdvs nother 1 sdfsdfs sdvsdvs', 3, 1, '2024-10-23 14:30:22', '2024-10-23 14:40:26', 3),
(6, 41, 1, 'Sydney Torkornoo', '\'rating\'     =&gt; (int)$result[\'rating\'],\r\n				\'rating\'     =&gt; (int)$result[\'rating\'],\r\n				\'rating\'     =&gt; (int)$result[\'rating\'],\r\n				\'rating\'     =&gt; (int)$result[\'rating\'],', 4, 1, '2024-10-23 14:38:49', '2024-10-23 14:40:37', 4),
(7, 41, 1, 'Sydney Torkornoo', 'final test final test final test final test final test final test', 4, 1, '2024-10-23 15:43:27', '0000-00-00 00:00:00', 5);
...
('8c0f31f77ecae40dc79df8d199', '{\"currency\":\"GBP\",\"review_token\":\"6f497d32d54df5e3b63dfc5975c5a06a\",\"customer\":{\"customer_id\":1,\"customer_group_id\":1,\"firstname\":\"Sydney\",\"lastname\":\"Torkornoo\",\"email\":\"sydney.torkornoo@gmail.com\",\"telephone\":\"\",\"custom_field\":[]},\"shipping_address\":{\"address_id\":1,\"firstname\":\"Sydney\",\"lastname\":\"Torkornoo\",\"company\":\"\",\"address_1\":\"10 Brookland Terrace,\",\"address_2\":\"Sayer Street,\",\"city\":\"Huntingdon\",\"postcode\":\"pe293nd\",\"zone_id\":\"3525\",\"zone\":\"Cambridgeshire\",\"zone_code\":\"CAMBS\",\"country_id\":\"222\",\"country\":\"United Kingdom\",\"iso_code_2\":\"GB\",\"iso_code_3\":\"GBR\",\"address_format\":\"{firstname} {lastname}\\r\\n{company}\\r\\n{address_1}\\r\\n{address_2}\\r\\n{city}, {zone} {postcode}\\r\\n{country}\",\"custom_field\":\"\",\"default\":1},\"customer_id\":\"1\",\"customer_token\":\"178c1c1d94adcaff8d03939cca\",\"login_token\":\"1c28217ccf5a858b21dcb944ad83a738\"}', '2024-10-24 15:43:40'),
('a198aa755b7314e9787b8ea74b', '{\"user_id\":\"1\",\"user_token\":\"c39168acaa63d1421e3cbcb16b2e0d29\"}', '2024-10-24 15:49:35');
...
(99, 0, 'config', 'config_email', 'sydney.torkornoo@gmail.com', 0),
...
(215, 0, 'config', 'config_encryption', '', 0),
...
(1, 1, 'admin', '$2y$10$b7NzSzmJTGYCX/xkOTCSTeY3VOtxr4..Il9hyZaGF1lC8Q15nqFNS', 'John', 'Doe', 'sydney.torkornoo@gmail.com', '', '', '::1', 1, '2024-10-23 12:07:54');
...
(1, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/130.0.0.0 Safari/537.36', '2024-10-23 12:52:10'),
(2, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/130.0.0.0 Safari/537.36', '2024-10-23 13:15:42'),
(3, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/130.0.0.0 Safari/537.36', '2024-10-23 13:16:37');
